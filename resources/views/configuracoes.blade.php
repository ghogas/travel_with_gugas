...
<div class="container">
    <div class="row p-3">
        <div class="col">
            <h5 class="fst-bold fs-5">Informações para <?php $user = auth()->user();
                                                        echo $user->name; ?></h5>
            <hr width=“2” size=“100”>
            <p>
        ...
        <div class="col">
            ...
            <hr width=“2” size=“100”>
            <button type="button" class="btn btn-link"><a href="{{route('perfil')}}"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
